...
plotPCA(vsd, intgroup = "group") + theme_minimal() +
    scale_color_manual(labels = c("HD, cortex", "HD, striatum", "WT, cortex", "WT, striatum"), values = c("#CC79A7", "#E69F00", "#56B4E9", "#009E73")) + coord_fixed(ratio = sqrt(20/65))
```
